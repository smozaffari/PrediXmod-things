...
ENcorvec <- read.table("Elastic_Net/GTEx_pilot_predicted_WB_GCOM1_2_3980_Corvec")
ENpvals <- read.table("Elastic_Net/GTEx_pilot_predicted_WB_GCOM1_2_3980_Pvals")
PSpvals<- read.table("Polygenic_score/GTEx_pilot_predicted_cis0.05_trans10e-05_WB_GCOM1_2_4621_Pvals")
PScorvec<- read.table("Polygenic_score/GTEx_pilot_predicted_cis0.05_trans10e-05_WB_GCOM1_2_4621_Corvec")
